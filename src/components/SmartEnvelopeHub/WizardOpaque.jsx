...
// ── Tipuri elemente (subset cu cele 5 tipice — PI+PR+PS+SE rămân în editor avansat) ──
const ELEMENT_TYPES_WIZARD = [
...
// Folosim NUMAI nume existente în materials.json pentru auto-completare corectă.
const LAYER_PRESETS = {
  PE: [
    {
      id: "PE-clasic",
...
// ── U_REF nZEB (simplificat — identic cu OpaqueModal) ────────────────────────
const U_REF_NZEB_RES  = { PE: 0.25, PT: 0.15, PP: 0.15, PB: 0.29, PL: 0.20 };
const U_REF_NZEB_NRES = { PE: 0.33, PT: 0.17, PP: 0.17, PB: 0.35, PL: 0.22 };
...
// ── Helper: material după nume → propagă TOATE câmpurile (fix D3) ────────────
function buildLayerFromMaterialName(name, thicknessMm) {
