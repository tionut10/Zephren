...
// ── Baze de date vitraj / ramă — identice cu GlazingModal pentru consistență ──
const GLAZING_DB = [
...
function getURefGlazing(category, isDoor) {
  if (isDoor) return U_REF_GLAZING.door;
  return ["RI", "RC", "RA"].includes(category) ? U_REF_GLAZING.nzeb_res : U_REF_GLAZING.nzeb_nres;
}

// ── Calcul U total (identic cu GlazingModal linie 45-59, cu fix arie minimă) ──
function computeUTotal(glazingName, frameName, frameRatio, area) {
