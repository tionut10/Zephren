...
export const CHANGELOG = [
  {
    ...
    label: "CURENT",
    items: [
      { icon: "💰", text: "Monetizare completă: 6 planuri (Free → Enterprise), credite pay-per-project, price-lock pe viață, ofertă lansare −30%" },
      { icon: "📦", text: `Catalog extins: ${TOTAL_PRODUCTS}+ produse — PV TOPCon/HJT/bifață, pompe căldură hibridă/geotermă, ferestre VIG/triple-glazed` },
      { icon: "📋", text: "Formular Audit Client — 6 secțiuni, colectare date pe teren, export JSON/CSV/Checklist" },
      { icon: "🎨", text: "Header redesign (3 zone), ImportHub centralizat Etapa 1, analiză planșă AI (Claude Vision)" },
      { icon: "📷", text: "Fotografii clădire în CPE DOCX (max 6 poze, Anexă), colorare automată celule clase energetice" },
      { icon: "✅", text: "nZEB badge prominent, clasă CO₂ corectă (aliniere Step5↔Step6), clase EP/CO₂ cu săgeată WCAG" },
      { icon: "🔬", text: "BACS EN 15232-1, ACM EN 15316, nZEB check, SRI, Pasivhaus, PNRR (v3.5–v3.10)" },
      { icon: "📜", text: "CPE Anexa 1+2 — recomandări reabilitare conform Mc 001-2022; Export XML MDLPA" },
      { icon: "🧠", text: "Bază de date constructivă exhaustivă: 10+ sisteme regenerabile, date per județ" },
    ],
  },
  {
    version: "3.3",
    week: "Săpt. 1b",
    dateRange: "6 – 7 apr 2026",
    color: "#6366f1",
    label: "",
    items: [
      { icon: "🔀", text: "Refactoring major: code split, JSON DB, 115 teste noi E2E + unitare (v3.3)" },
      { icon: "📥", text: "7 metode import date: IFC/BIM, OSM geocodare, foto fațadă, chatbot verbal, QR/link, paste XML, facturi energie" },
      { icon: "⚡", text: "Quick Fill Wizard — completare automată date clădire în ~60 secunde prin selecții vizuale" },
      { icon: "🏥", text: "Demo-uri reale validate: Spital Petroșani, Liceu Târgoviște, Bloc T770, disertații master (14 proiecte)" },
    ],
  },
  {
    version: "3.1",
    week: "Săpt. 1a",
    dateRange: "31 mar – 5 apr 2026",
    color: "#10b981",
    label: "",
    items: [
      { icon: "📄", text: "Generare CPE DOCX server-side via python-docx (Vercel Python API) — culori reale template MDLPA" },
      { icon: "🗺️", text: "Hartă climatică reală România (Natural Earth coordinates) cu tooltip hover și selecție localitate" },
      { icon: "📊", text: "Export Excel profesional 9 foi + CSV; clase energetice scală corectată A+ cea mai scurtă" },
      { icon: "🔧", text: "Conformitate completă Mc 001-2022 — eliminare EPBD, scale corecte, 5 demo-uri reale noi" },
      { icon: "♻️", text: "Performance: lazy loading, service worker actualizat, fix stale cache, compatibilitate producție" },
    ],
  },
  {
    version: "2.0",
    week: "Săpt. 1",
    dateRange: "30 mar 2026",
    color: "#22c55e",
    label: "LANSARE",
    items: [
      { icon: "🚀", text: "Lansare Zephren (rebrand din CertEn): calculator CPE complet 8 pași, Mc 001-2022" },
      { icon: "🌐", text: "Pagina principală, router cu lazy loading, asistent AI integrat, documentație API" },
      { icon: "📡", text: "Full-stack: autentificare, sincronizare cloud, plăți, export multi-format, teste" },
      { icon: "📐", text: "Vizualizare 3D izometrică clădire cu ferestre, uși, balcoane, acoperiș, niveluri, busolă" },
      { icon: "📶", text: "PWA offline, grafic radar, mod prezentare, deviz estimativ, notificări push" },
    ],
  },
];
