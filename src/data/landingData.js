...
export const PLANS = [
  ...
  },
  {
    ...
    priceAn: "4.990",
    discount: "/an (10 luni)",
    audience: "Auditor energetic AE IIci · grad II civile · CPE locuințe (case + bloc nou + apartament) · 36 CPE/lună (30 + 6 burst)",
    ...
    features: [
      ...
      "Overage: 39→69→99 RON/CPE pe trepte",
  ...
  },
  {
    ...
    audience: "Auditor energetic AE Ici · grad I civile · CPE + audit + nZEB toate clădirile (rezidențial + nerezidențial + public) · 36 CPE/lună (30 + 6 burst) + 3 audituri/lună (2 + 1 burst)",
    ...
    features: [
      ...
      "30 CPE/lună incluse + 6 burst gratis",
      "2 audituri energetice/lună incluse + 1 burst gratis",
      "Overage CPE: 39→69→99 RON/CPE",
  ...
  },
  {
    ...
    audience: "Auditor senior AE Ici + consultant · CPE + audit + nZEB + BIM + Pasivhaus + MonteCarlo · 36 CPE/lună (30 + 6 burst) + 6 audituri/lună (4 + 2 burst)",
    features: [
      "Tot Zephren AE Ici, plus:",
      "Step 8 COMPLET (18 module avansate)",
      "30 CPE/lună + 6 burst gratis · Overage 39→69→99 RON",
      "4 audituri energetice/lună + 2 burst gratis · Overage 999→1.499→1.999 RON",
