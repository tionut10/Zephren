...
export const OPAQUE_WALL_TYPES = [
  // ── PEREȚI DIN ZIDĂRIE ──────────────────────────────────────────────────
  {
    ...
    lambda: { min: 0.70, max: 0.90, unit: "W/mK" },
...
export const CEILING_TYPES = [
  {
    ...
    density: 2400,
    rsi: "0.10 (orizontal sus — flux termic ascendent, ISO 6946:2017 Tab.1)",
    thermal_mass: "FOARTE ÎNALT",
...
export const THERMAL_BRIDGES = [
  ...
  },
  {
    ...
    label: "Contur fereastră (montaj standard în zidărie)",
    psi_coefficient: { min: 0.06, max: 0.10, unit: "W/mK" },
    location: "Perimetrul ferestrei (glaf, montant, pervaz)",
    weight_in_balance: "5-10%",
    minimization: "Montaj în planul izolației sau cu consolă RAL",
    standard: "ISO 14683:2017 Tabel 1 (tip W)",
    notes: "ISO 14683:2017 tip W: Ψ=0.06-0.09 W/(m·K). Valori >0.10 sunt specifice consolelor balcon sau detaliilor fără ruptură termică.",
  },
  {
