...
// Sprint Reorg Pas 5/7 (15 mai 2026) — imports prețuri/inflație/currency mutate la Pas 7.
// Cardurile NPV bandă, cost energie cu preseturi, cost reabilitare au plecat din Pas 5.
...
export default function Step5Calculation(props) {
  const {
    ...
    useNA2023, setUseNA2023,
    compareRef, setCompareRef, importCompareRef,
    rehabComparison, // Sprint Reorg Pas 5/7 — folosit DOAR în Radar (vals "după rehab") — restul scenariu config a fost mutat la Pas 7
