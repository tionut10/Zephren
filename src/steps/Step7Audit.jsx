...
import Phase1Diagnose from "./Step7/Phase1Diagnose.jsx"; // D1 Sprint Optimizări 16 mai 2026
          ...
          ← Pas 6: Certificat
            ...
            <div>
              ...
              <div className="space-y-5">
                ...
                {/* ═══════════════════════════════════════════════════════════════════ */}
                {/* F1 · DIAGNOSTIC — Extras în Phase1Diagnose.jsx (D1 Sprint Optimizări 16 mai 2026) */}
                {/* Mc 001-2022 §8.2 + EN 16247-2                                       */}
                {/* ═══════════════════════════════════════════════════════════════════ */}
                <Phase1Diagnose
                  t={t} lang={lang}
                  enClass={enClass} co2Class={co2Class}
                  epFinal={epFinal} co2Final={co2Final}
                  rer={rer} isNZEB={isNZEB}
                  instSummary={instSummary} envelopeSummary={envelopeSummary} renewSummary={renewSummary}
                  building={building} selectedClimate={selectedClimate}
                  userPlan={userPlan} auditorGrad={auditorGrad}
                />
                {/* ═════════════════════════════════════ Faza 1 — extras în sub-component Phase1Diagnose.jsx ═════════════════════════════════════ */}
