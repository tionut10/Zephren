                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: "32px", alignItems: "center", flexWrap: "wrap" }}>
                      <div>
                        ...
                        <p style={{ fontSize: "14px", color: textMuted, lineHeight: 1.6, marginBottom: "16px" }}>
                          {lang === "EN"
                            ? "All Expert features (Step 1-8 + AI Pack + BIM Pack) free for students, doctoral candidates, graduates awaiting MDLPA attestation, and trainees in audit offices. Practice on real CPE and energy audit projects without the risk of issuing unofficial certificates — documents carry the SCOP DIDACTIC watermark. Calculations fully cover the MDLPA attestation exam syllabus (Ord. 348/2026): Mc 001-2022. Perfect for your bachelor thesis, dissertation, or attestation portfolio — all calculations are exportable as DOCX with full tables and annexes. 60 Romanian climate zones + 165 thermal bridges — not simulated data, but the production database."
                            : "Toate funcțiile Expert (Step 1-8 + AI Pack + BIM Pack) gratis pentru studenți, doctoranzi, absolvenți în curs de atestare MDLPA și stagiari în birouri de audit. Practică pe proiecte reale de CPE și audit energetic fără riscul emiterii unui document neoficial — fișierele poartă ștampila SCOP DIDACTIC. Calculele acoperă integral materia examenului de atestare MDLPA (Ord. 348/2026): Mc 001-2022. Ideal pentru proiectul de licență, disertație sau dosarul de atestare — calculele sunt exportabile ca DOCX cu toate tabelele și anexele. 60 localități climatice RO + 165 punți termice — nu date simulate, ci baza de date a aplicației de producție."}
                        </p>
